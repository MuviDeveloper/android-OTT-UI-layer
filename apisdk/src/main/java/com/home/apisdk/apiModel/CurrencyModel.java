...
public class CurrencyModel implements Serializable {
    ...
    String currencyAcryCode="";  // for SCA Customers

    public String getCurrencyAcryCode() {
        return currencyAcryCode;
    }

    public void setCurrencyAcryCode(String currencyAcryCode) {
        this.currencyAcryCode = currencyAcryCode;
    }
