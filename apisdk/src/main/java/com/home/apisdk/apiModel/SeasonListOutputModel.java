...
public class SeasonListOutputModel {
    String title = "";
    String description = "";
    ...
    public ArrayList<SeasonListOutputModel> getSeasonListOutputModelList() {
        return seasonListOutputModelList;
    }

    public void setSeasonListOutputModelList(ArrayList<SeasonListOutputModel> seasonListOutputModelList) {
        this.seasonListOutputModelList = seasonListOutputModelList;
    }

    ArrayList<SeasonListOutputModel> seasonListOutputModelList = new ArrayList<>();
