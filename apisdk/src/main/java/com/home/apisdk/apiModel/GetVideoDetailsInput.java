...
public class GetVideoDetailsInput {
    ...
    String language;
    String countryCode;
    private String vastAdParameter;
    ...
    /**
     * This method is used to set the paramater for VAST Ad
     *
     * @param vastAdParameter
     */
    public void setAdParameter(String vastAdParameter) {
        this.vastAdParameter = vastAdParameter;
    }

    /**
     * This method is used to get the paramater for VAST Ad
     */
    public String getVastAdParameter() {
        return vastAdParameter;
    }
}
