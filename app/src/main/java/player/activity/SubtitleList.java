...
public class SubtitleList extends Activity{
    ...
    public static SubtitleList subtitleList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringArrayListExtra("AudioNew") != null) {
            AudioNew = getIntent().getStringArrayListExtra("AudioNew");
        } else {
            AudioNew.clear();
        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position != 0)
                playerIntent.putExtra("code", SubTitlePath.get(position- 1) );
                else
                    playerIntent.putExtra("code", "off" );
