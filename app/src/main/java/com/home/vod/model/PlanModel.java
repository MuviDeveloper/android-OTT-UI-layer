...
public class PlanModel {
    ...
    private String planCurrencyAcyrCode;

    public String getPlanCurrencyAcyrCode() {
        return planCurrencyAcyrCode;
    }
    ...
    public void setPlanCurrencyAcyrCode(String planCurrencyAcyrCode) {
        this.planCurrencyAcyrCode = planCurrencyAcyrCode;
    }


    public PlanModel(String planNameStr, String purchaseValueStr, String planRecurrenceStr, String planFrequencuStr,
                     boolean isSelected, String studioIdStr, int planStatusStr, String planLanguage_idStr,
                     String planIdStr, String planCurrencyIdStr, String planCurrencySymbolstr,
                     String planTrialPeriodStr, String planTrialRecurrenceStr, String currencyCountryCodeStr,String planCurrencyAcyrCode) {
